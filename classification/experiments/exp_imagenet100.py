...
if __name__=='__main__':
    ...
    if args.exp == 0:
        server = 'toast'
        save_dir_init = '/data/sung/checkpoint/norm_corruption'
        data_dir = '/data/sung/dataset'

        exp_name = 'imagenet100_base'
        comb_list = []
        epoch = 100
    ...
    # Setup Configuration for Each Experiments
        ...
        exp_name = 'imagenet100_corruption'
        comb_list = []
        epoch = 100
                    ...
                    for severe in [1,2,3,4,5]:
                        comb_list.append({'train': 
                                        ...
                                        'data':
                                                {'data_type': data[0],
                                                'num_class': data_num},
                                        'index': '%s/severe_%d/%s' %(corrupt, severe, n_t),
                                        })
    ...
    def tr_gpu(comb, ix):
        ...
        for i, comb_ix in enumerate(comb):
            ...
            # Run !
            script = 'python ../main.py --save_dir %s --log %s' %(save_dir, log)
