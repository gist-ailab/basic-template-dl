        ...
        for n_t in network_list:
            for init_class in [5, 10, 20, 50]:
                for seed in [11]:
                    ...
                    total_task = int(100 / init_class)
                    method = 'entropy'
                    init_path = '/data/sung/checkpoint/inclearn/init/cifar100_B%d/%s_fc/seed%d/best_model.pt' %(init_class, n_t, seed)
                    ...
                    comb_list.append({'train':
                                            ...
                                            "common_extractor": False,
                                            "common_classifier": False,
  
                                            "inclearn_method": method
                                            },
                                            
                                    'meta': {'task': 'cifar100_B%d_C%d_seed%d' %(init_class, init_class, seed),
                                    ...
                                    'index': 'cifar100_B%d_C%d/%s/%s_fc/seed%d' %(init_class, init_class, method, n_t, seed),
                                    })


    # 2. Maximum Logit and Score
    elif args.exp == 2:
        server = 'toast'
        save_dir_init = '/data/sung/checkpoint/inclearn/'
        data_dir = '/data/sung/dataset'
